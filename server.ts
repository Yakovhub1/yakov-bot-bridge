...
for (const record of data.records) {
  ...
  // 2. תזכורת בוקר (10:00 - 10:10)
  if (hour === 10 && minute  setTimeout(r, 20000));
    }
  }

  // 3. תזכורות ערב (21:00 - 21:10)
  if (hour === 21 && minute = now.startOf("day")) { isActive = true; }
    }
...
1 minute ago
    ...
    if (f.Daily_reminder === true || (isActive && isWeighEve)) {
      ...
      if (f.Has_Tablets === true) { msg += " וזכרת לקחת את הטבליות שלך?"; }
